...
begin
	adventurers1 = adventurers[1:250]
	adventurers2 = adventurers[251:500]
	adventurers3 = adventurers[501:750]
	adventurers4 = adventurers[751:1000]
end
...
begin
	craftsmen1 = craftsmen[1:250]
	craftsmen2 = craftsmen[251:500]
	craftsmen3 = craftsmen[501:750]
	craftsmen4 = craftsmen[751:1000]
end

# ╔═╡ 99abcb33-a93a-406e-a44f-96e6ef17f98c
begin
	play!(adventurers1, craftsmen1, 1, 10, 20000)
	play!(adventurers2, craftsmen2, 2, 10, 20000)
	play!(adventurers3, craftsmen3, 3, 10, 20000)
	play!(adventurers4, craftsmen4, 4, 10, 20000)
end
...
# ╔═╡ 96ec74c3-8f65-458a-894a-c4f857874502
begin
	weapons1 = dict_to_array(countmap(typeof.([adventurer.weapon for adventurer in adventurers1])))
	weapons2 = dict_to_array(countmap(typeof.([adventurer.weapon for adventurer in adventurers2])))
	weapons3 = dict_to_array(countmap(typeof.([adventurer.weapon for adventurer in adventurers3])))
	weapons4 = dict_to_array(countmap(typeof.([adventurer.weapon for adventurer in adventurers4])))
end

# ╔═╡ bd069907-f86b-4683-a90e-05de90500ace
bar(["basic weapon", "warrior weapon", "legendary weapon", "ultimate weapon"], 		
	weapons1, label="total weapons", title="Enemy: 10 loot, 1 gold")

# ╔═╡ 5d768b72-c707-4cee-a0f3-3b8f19ef3902
bar(["basic weapon", "warrior weapon", "legendary weapon", "ultimate weapon"], 		
	weapons2, label="total weapons", title="Enemy: 5 loot, 1 gold")

# ╔═╡ 56ad3daf-a407-4f87-9154-4beecbd4edd1
bar(["basic weapon", "warrior weapon", "legendary weapon", "ultimate weapon"], 		
	weapons3, label="total weapons", title="Enemy: 5 loot, 2 gold")

# ╔═╡ 70055295-5d7c-46a0-9920-249ea14c4b8c
bar(["basic weapon", "warrior weapon", "legendary weapon", "ultimate weapon"], 		
	weapons4, label="total weapons", title="Enemy: 5 loot, 4 gold")
